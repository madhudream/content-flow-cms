...
export function initCMSMode() {
  ...
  console.log('[Demo App] CMS mode enabled');
  ...
  const initTimeout = setTimeout(() => {
    console.warn('[Demo App] CMS initialization timeout - enabling anyway');
  ...
  function handleCMSMessage(event: MessageEvent) {
    ...
    if (message.type === 'CONTENTFLOW_CMS_INIT') {
      ...
      console.log('[Demo App] Received CMS_INIT');
...
function enableContentClickHandlers() {
  ...
  document.body.addEventListener('click', (event) => {
    ...
    console.log('[Demo App] Content clicked:', contentId);
  });

  console.log('[Demo App] Click handlers enabled');
}
...
function injectCMSStyles() {
  ...
  console.log('[Demo App] CMS styles injected');
}
...
function handlePreviewUpdate(message: PreviewUpdateMessage) {
  ...
  console.log('[Demo App] Preview updated:', contentId, newValue);
}
