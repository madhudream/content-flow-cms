...
const STORAGE_KEY = 'bwo-taxforms-language';
  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-full flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200 text-sm font-medium shadow-sm hover:shadow-md"
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown menu */}
          <div className="absolute left-0 bottom-full mb-2 w-full bg-white rounded-lg shadow-xl z-20 overflow-hidden">
            {LANGUAGES.map((lang) => (
              <button
                key={lang.code}
