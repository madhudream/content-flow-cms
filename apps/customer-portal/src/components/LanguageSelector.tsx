...
const STORAGE_KEY = 'customer-portal-language';
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-all duration-200 text-sm font-medium shadow-sm hover:shadow-md"
            ...
            {LANGUAGES.map((lang) => (
              <button
                ...
                className={`w-full text-left px-4 py-2.5 text-sm hover:bg-indigo-50 transition-colors ${
                  lang.code === currentLanguage ? 'bg-indigo-100 font-medium text-indigo-700' : 'text-gray-700'
                }`}
              >
                {lang.label}
              </button>
